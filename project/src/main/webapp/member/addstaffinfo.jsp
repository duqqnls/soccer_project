...
<div class="container">
    ...
    <input type="button" class="staffadd" value="스태프 추가" onclick="window.open('addstaffinsert.jsp', '_blank', 'width=600,height=800');">
        <h3>스포츠 사이언티스트</h3>
            ...
            <div class="profile-card">
                ...
                <div class="profile-info">
                    ...
                    <div class="button-container">
	                    <input type="button" class="staffbtn" value="수정" onclick="window.open('addstaffupdate.jsp?code=<%=staff.getCode() %>', '', 'width=600, height=800')">
