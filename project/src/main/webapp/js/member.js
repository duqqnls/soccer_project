...
function findMemberInfo(){
	...
	var idCheck = document.getElementById("findId");
	var pwdCheck = document.getElementById("findPw");
	...
	if (idCheck.checked) {
	    //alert(idCheck.checked);
		findFrm.findFlag.value = "id";
		findFrm.submit();

	} else if(pwdCheck.checked) {
		findFrm.findFlag.value = "passwd";
		if (id === ""){
			alert("아이디를 입력하세요");
			return false;
		}
