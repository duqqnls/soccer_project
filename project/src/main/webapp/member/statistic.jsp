            ...
            <div class="table-container">
                ...
                <div class="right-section">
                    ...
                    <select id="columnOrder" name="column">
                        ...
                        <option value="stat_code">일련번호</option>
                    ...
                    <button type="button" onclick="window.open('insertstat.jsp', '', 'width=600, height=900, status=no,toolbar=no,scrollbars=no,location=no,menubar=no')">추 가</button>
                </div>
            </div>
        </form>
        ...
        <form name="deleteStatFrm">
            ...
            <div id="resultTable">
                <table style="text-align: left;" border="1">
                    <tr>
                        <th>선수코드</th><th>등번호</th><th>선수명</th><th>시즌</th><th>출전경기</th><th>골</th><th>도움</th><th>경고</th><th>퇴장</th><th>수정/삭제</th>
                    </tr>
                    ...
                    %>
                        <tr style="text-align: center;">
                            ...
                            <td>
                                ...
                                <button type="button" onclick="window.open('updatestat.jsp?code=<%=s.getCode() %>', '', 'width=540, height=880')">수정</button>
