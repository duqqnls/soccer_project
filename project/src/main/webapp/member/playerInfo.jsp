...
<div class="container">
	<div class="top-section">
        <input type="button" class="add-button" value="선수 추가" onclick="addPlayer()">
    </div>
            ...
            <div class="profile-card">
                ...
                <div class="profile-info">
                    ...
                    <div class="button-container">
	                    <input type="button" class="button-common" value="수정" onclick="editPlayer('<%= player.getBn() %>', '<%= player.getName() %>', '<%= player.getBirth() %>', '<%= player.getNation() %>')">
	                    <input type="button" class="button-common" value="삭제" onclick="deletePlayer('<%= player.getBn() %>')">
	                </div>
                </div>
            </div>
            <% } %>
