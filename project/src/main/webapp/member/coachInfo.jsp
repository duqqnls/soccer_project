...
<div class="container">
    ...
    <%
        ...
        ArrayList<CoachBean> headCoachList = coachMgr.getCoachesByCategory("감독"); 
        ArrayList<CoachBean> coachList = coachMgr.getAllCoaches();
        ArrayList<CoachBean> trainerList = coachMgr.getCoachesByCategory("트레이너");
        ArrayList<CoachBean> doctorList = coachMgr.getCoachesByCategory("주치의");
        ArrayList<CoachBean> equipmentManagerList = coachMgr.getCoachesByCategory("장비관리사");
        ArrayList<CoachBean> sportsScientistList = coachMgr.getCoachesByCategory("스포츠사이언티스트");
    %>
