...
<%
    ...
    if (!isEdit) {
        ...
        coach = coachMgr.getByCoachCode(code);
    } else {
        ...
        if (name.isEmpty()) {
            ...
            CoachBean existingCoach = coachMgr.getByCoachCode(originalCode);
            if (!name.equals(existingCoach.getName()) && coachMgr.isNameDuplicate(name)) {
                errorMsg = "중복된 이름입니다.";
            } else {
