...
function expendAdd() {
    window.open('expendadd.jsp', '_blank', 'width=600,height=400,left=200,top=200');
...
function editExpend(code) {
    window.open('expendupdate.jsp?expend_code=' + code, 'expendUpdateWindow', 'width=600,height=450');
}

function deleteExpend(code) {
    window.open('expenddelete.jsp?expend_code=' + code, 'expendDeleteWindow', 'width=500,height=300');
}
